import pygame
from UI.Tipografia import Tipografia
...
def break_line(text:str, start_pos: pygame.Vector2, max_size=300) -> list[Tipografia]:
    texts = []
    chars = []
    total_w = 0
    indice = 0
    ...
    for i in chars:
        ...
        if total_w + t.get_width() > max_size:
            start_pos.y += 20
            total_w = 0
            texts.append(Tipografia(((start_pos.x, start_pos.y)),
