...
class TelaPergunta(Tela):
    def __init__(self, screen, transition_call, id_materia, id_partida):
        ...
        self.parar_btn = Botao((1, 50), (200, 45), pygame.Color("orange"), "Parar", pygame.font.Font(None, 28))
    ...
    def encerrar_jogo(self):
        ...
        self.transition_call(TelaInicio(self.screen, self.transition_call))
